define("select-kit/templates/components/tag-drop/tag-drop-header", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
