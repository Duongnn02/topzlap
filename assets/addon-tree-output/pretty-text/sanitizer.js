define("pretty-text/sanitizer", ["exports", "xss", "discourse-common/lib/escape"], function (_exports, _xss, _escape) {
  ...
  0; //eaimeta@70e063a35619d71f0,"xss",0,"discourse-common/lib/escape"eaimeta@70e063a35619d71f
  ...
  function sanitize(text, allowLister) {
    ...
    let result = (0, _xss.default)(text, {
      ...
      onIgnoreTagAttr(tag, name, value) {
        ...
        if (forTag) {
          ...
          if (forAttr && (forAttr.includes("*") || forAttr.includes(value)) || !name.includes("data-html-") && name.startsWith("data-") && (forTag["data-*"] || testDataAttribute(forTag, name, value)) || tag === "a" && name === "href" && hrefAllowed(value, extraHrefMatchers) || tag === "iframe" && name === "src" && allowedIframes.some(i => {
