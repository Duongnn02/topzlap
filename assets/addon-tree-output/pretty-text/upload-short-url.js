define("pretty-text/upload-short-url", ["exports", "discourse-common/lib/debounce", "I18n", "rsvp"], function (_exports, _debounce, _I18n, _rsvp) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"discourse-common/lib/debounce",0,"I18n",0,"rsvp"eaimeta@70e063a35619d71f
  let _cache = {};
  ...
  function retrieveCachedUrl(upload, siteSettings, dataAttribute, opts, callback) {
    ...
    if (url) {
      ...
      if (url !== MISSING) {
        ...
        context.strokeRect(0, 0, canvas.width, canvas.height);
        let fontSize = 25;
        const text = _I18n.default.t("image_removed");
  ...
  function _loadShortUrls(uploads, ajax, siteSettings, opts) {
    ...
    if (!queueUrls) {
      queueUrls = [...urls];
      queuePromise = new _rsvp.Promise(resolve => {
        queueResolve = resolve;
      });
      (0, _debounce.default)(null, queuePop, ajax, 450);
    } else {
      queueUrls.push(...urls);
    }
  ...
  const SHORT_URL_ATTRIBUTES = "img[data-orig-src], a[data-orig-href], source[data-orig-src]";
