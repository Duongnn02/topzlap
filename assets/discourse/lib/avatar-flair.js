define("discourse/lib/avatar-flair", ["exports"], function (_exports) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.default = autoGroupFlairForUser;
  _exports.resetFlair = resetFlair;
  0; //eaimeta@70e063a35619d71feaimeta@70e063a35619d71f
  let _autoGroupFlair, _noAutoFlair;
  function autoGroupFlairForUser(site, user) {
    if (!_autoGroupFlair) {
  ...
  function initializeAutoGroupFlair(site) {
    _autoGroupFlair = {};
    _noAutoFlair = true;
    ["admins", "moderators", "staff", "trust_level_0", "trust_level_1", "trust_level_2", "trust_level_3", "trust_level_4"].forEach(groupName => {
