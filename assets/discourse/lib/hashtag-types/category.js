define("discourse/lib/hashtag-types/category", ["exports", "discourse/lib/hashtag-types/base", "@ember/service"], function (_exports, _base, _service) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"discourse/lib/hashtag-types/base",0,"@ember/service"eaimeta@70e063a35619d71f
  ...
  let CategoryHashtagType = (_class = class CategoryHashtagType extends _base.default {
    constructor() {
      super(...arguments);
    ...
    generateColorCssClasses(model) {
      ...
      if (model.parentCategory) {
        backgroundGradient.push(`var(--category-${model.parentCategory.id}-color) 50%`);
      } else {
  ...
  _exports.default = CategoryHashtagType;
});