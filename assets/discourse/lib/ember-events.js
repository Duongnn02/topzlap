define("discourse/lib/ember-events", ["exports", "@ember/component", "@ember/object", "discourse/lib/ember-action-modifier", "ember"], function (_exports, _component, _object, _emberActionModifier, _ember) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.normalizeEmberEventHandling = normalizeEmberEventHandling;
  0; //eaimeta@70e063a35619d71f0,"@ember/component",0,"@ember/object",0,"discourse/lib/ember-action-modifier",0,"ember"eaimeta@70e063a35619d71f
   ...
   */
  function normalizeEmberEventHandling(app) {
  ...
  function eliminateClassicEventDelegation() {
    ...
    _ember.default.EventDispatcher.reopen({
      events: {}
    });
  }
  ...
  function rewireActionModifier(appInstance) {
    ...
    renderer._runtimeResolver.lookupModifier = (name, owner) => {
      if (name === "action") {
        return _emberActionModifier.actionModifier;
      } else {
