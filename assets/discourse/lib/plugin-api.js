define("discourse/lib/plugin-api", ["exports", "I18n", "discourse/components/composer-editor", "discourse/widgets/post-menu", "discourse/helpers/category-link", "discourse/widgets/post-stream", "discourse/models/user", "discourse/widgets/header", "discourse/widgets/widget", "discourse-common/lib/icon-library", "discourse/models/composer", "discourse/components/discourse-banner", "discourse/lib/keyboard-shortcuts", "discourse/lib/sharing", "discourse/components/search-advanced-options", "discourse/mixins/card-contents-base", "discourse/components/edit-category-settings", "discourse/widgets/post-cooked", "discourse/controllers/discovery-sortable", "discourse/lib/render-topic-featured-link", "discourse/lib/page-tracker", "discourse/components/global-notice", "discourse/models/nav-item", "discourse/components/d-document", "discourse/components/plugin-connector", "discourse/components/reviewable-item", "discourse/services/composer", "discourse/widgets/post", "discourse/widgets/post-small-action", "discourse/widgets/quick-access-profile", "discourse/lib/render-tags", "discourse/components/d-editor", "discourse/widgets/topic-map", "discourse/widgets/toggle-topic-summary", "discourse/components/topic-title", "discourse/widgets/user-menu", "discourse/components/user-menu/profile-tab-content", "discourse/helpers/decorate-username-selector", "discourse/components/mount-widget", "discourse-common/lib/deprecated", "discourse/widgets/poster-name", "discourse/lib/plugin-connectors", "discourse-common/lib/get-owner", "virtual-dom", "discourse/lib/transform-post", "select-kit/mixins/plugin-api", "@ember/object/evented", "discourse/helpers/user-avatar", "discourse/controllers/topic", "discourse/lib/highlight-syntax", "discourse/lib/register-topic-footer-button", "discourse/lib/register-topic-footer-dropdown", "discourse/lib/desktop-notifications", "discourse/lib/utilities", "discourse/lib/render-tag", "discourse/models/topic", "discourse/routes/new-category", "discourse/lib/search", "discourse/widgets/search-menu-results", "select-kit/components/user-chooser", "discourse/lib/download-calendar", "discourse/lib/source-identifier", "discourse/lib/sidebar/custom-community-section-links", "discourse/lib/sidebar/custom-sections", "discourse/lib/sidebar/user/categories-section/category-section-link", "discourse/components/sidebar/user/categories-section", "discourse/lib/url", "discourse/lib/notification-types-manager", "discourse/lib/user-menu/tab", "discourse/lib/model-transformers", "discourse/controllers/user-private-messages", "discourse/controllers/full-page-search", "discourse/lib/hashtag-autocomplete"], function (_exports, _I18n, _composerEditor, _postMenu, _categoryLink, _postStream, _user, _header, _widget, _iconLibrary, _composer, _discourseBanner, _keyboardShortcuts, _sharing, _searchAdvancedOptions, _cardContentsBase, _editCategorySettings, _postCooked, _discoverySortable, _renderTopicFeaturedLink, _pageTracker, _globalNotice, _navItem, _dDocument, _pluginConnector, _reviewableItem, _composer2, _post, _postSmallAction, _quickAccessProfile, _renderTags, _dEditor, _topicMap, _toggleTopicSummary, _topicTitle, _userMenu, _profileTabContent, _decorateUsernameSelector, _mountWidget, _deprecated, _posterName, _pluginConnectors, _getOwner, _virtualDom, _transformPost, _pluginApi, _evented, _userAvatar, _topic, _highlightSyntax, _registerTopicFooterButton, _registerTopicFooterDropdown, _desktopNotifications, _utilities, _renderTag, _topic2, _newCategory, _search, _searchMenuResults, _userChooser, _downloadCalendar, _sourceIdentifier, _customCommunitySectionLinks, _customSections, _categorySectionLink, _categoriesSection, _url, _notificationTypesManager, _tab, _modelTransformers, _userPrivateMessages, _fullPageSearch, _hashtagAutocomplete) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.withPluginApi = withPluginApi;
  0; //eaimeta@70e063a35619d71f0,"I18n",0,"discourse/components/composer-editor",0,"discourse/widgets/post-menu",0,"discourse/helpers/category-link",0,"discourse/widgets/post-stream",0,"discourse/models/user",0,"discourse/widgets/header",0,"discourse/widgets/widget",0,"discourse-common/lib/icon-library",0,"discourse/models/composer",0,"discourse/components/discourse-banner",0,"discourse/lib/keyboard-shortcuts",0,"discourse/lib/sharing",0,"discourse/components/search-advanced-options",0,"discourse/mixins/card-contents-base",0,"discourse/components/edit-category-settings",0,"discourse/widgets/post-cooked",0,"discourse/controllers/discovery-sortable",0,"discourse/lib/render-topic-featured-link",0,"discourse/lib/page-tracker",0,"discourse/components/global-notice",0,"discourse/models/nav-item",0,"discourse/components/d-document",0,"discourse/components/plugin-connector",0,"discourse/components/reviewable-item",0,"discourse/services/composer",0,"discourse/widgets/post",0,"discourse/widgets/post-small-action",0,"discourse/widgets/quick-access-profile",0,"discourse/lib/render-tags",0,"discourse/components/d-editor",0,"discourse/widgets/topic-map",0,"discourse/widgets/toggle-topic-summary",0,"discourse/components/topic-title",0,"discourse/widgets/user-menu",0,"discourse/components/user-menu/profile-tab-content",0,"discourse/helpers/decorate-username-selector",0,"discourse/components/mount-widget",0,"discourse-common/lib/deprecated",0,"discourse/widgets/poster-name",0,"discourse/lib/plugin-connectors",0,"discourse-common/lib/get-owner",0,"virtual-dom",0,"discourse/lib/transform-post",0,"select-kit/mixins/plugin-api",0,"@ember/object/evented",0,"discourse/helpers/user-avatar",0,"discourse/controllers/topic",0,"discourse/lib/highlight-syntax",0,"discourse/lib/register-topic-footer-button",0,"discourse/lib/register-topic-footer-dropdown",0,"discourse/lib/desktop-notifications",0,"discourse/lib/utilities",0,"discourse/lib/render-tag",0,"discourse/models/topic",0,"discourse/routes/new-category",0,"discourse/lib/search",0,"discourse/widgets/search-menu-results",0,"select-kit/components/user-chooser",0,"discourse/lib/download-calendar",0,"discourse/lib/source-identifier",0,"discourse/lib/sidebar/custom-community-section-links",0,"discourse/lib/sidebar/custom-sections",0,"discourse/lib/sidebar/user/categories-section/category-section-link",0,"discourse/components/sidebar/user/categories-section",0,"discourse/lib/url",0,"discourse/lib/notification-types-manager",0,"discourse/lib/user-menu/tab",0,"discourse/lib/model-transformers",0,"discourse/controllers/user-private-messages",0,"discourse/controllers/full-page-search",0,"discourse/lib/hashtag-autocomplete"eaimeta@70e063a35619d71f
  ...
  function canModify(klass, type, resolverName, changes) {
    if (!changes.pluginId) {
      ...
      console.warn((0, _sourceIdentifier.consolePrefix)(), "To prevent errors in tests, add a `pluginId` key to your `modifyClass` call. This will ensure the modification is only applied once.");
      return true;
    }
  ...
  function wrapWithErrorHandler(func, messageKey) {
    return function () {
      try {
        ...
        document.dispatchEvent(new CustomEvent("discourse-error", {
          detail: {
            messageKey,
            error
          }
  ...
  class PluginApi {
    ...
    _resolveClass(resolverName, opts) {
      opts = opts || {};
      if (this.container.cache[resolverName] || resolverName === "model:user" && this.container.lookup("service:current-user")) {
        // eslint-disable-next-line no-console
        console.warn((0, _sourceIdentifier.consolePrefix)(), `"${resolverName}" has already been initialized and registered as a singleton. Move the modifyClass call earlier in the boot process for changes to take effect. https://meta.discourse.org/t/262064`);
      }
      const klass = this.container.factoryFor(resolverName);
      if (!klass) {
        if (!opts.ignoreMissing) {
          // eslint-disable-next-line no-console
          console.warn((0, _sourceIdentifier.consolePrefix)(), `"${resolverName}" was not found by modifyClass`);
        }
        return;
      }
      return klass;
    ...
    modifyClass(resolverName, changes, opts) {
      ...
      if (canModify(klass, "member", resolverName, changes)) {
        ...
        if (klass.class.reopen) {
          ...
          Object.defineProperties(klass.class.prototype || klass.class, Object.getOwnPropertyDescriptors(changes));
        }
      }
      return klass;
    }
    ...
    decorateCooked(callback, opts) {
      this.decorateCookedElement((element, decoratorHelper) => callback($(element), decoratorHelper), opts);
    }
    ...
    addKeyboardShortcut(shortcut, callback) {
      ...
      _keyboardShortcuts.default.addShortcut(shortcut, callback, opts);
    }
    ...
    addPosterIcons(cb) {
      ...
      (0, _widget.decorateWidget)(`poster-name:${loc}`, dec => {
    ...
    _deprecateDecoratingHamburgerWidgetLinks(name, fn) {
      if (name === "hamburger-menu:generalLinks" || name === "hamburger-menu:footerLinks") {
        ...
        if (siteSettings.navigation_menu !== "legacy") {
          try {
            ...
            const textContent = rawLabel || _I18n.default.t(label);
            const args = {
            ...
            if (href) {
              if (_url.default.isInternal(href)) {
                args.href = href;
              } else {
            ...
            (0, _deprecated.default)(`Usage of \`api.decorateWidget('hamburger-menu:generalLinks')\` is incompatible with the \`navigation_menu\` site setting when not set to "legacy". Please use \`api.addCommunitySectionLink\` instead.`, {
    ...
    attachWidgetAction(widget, actionName, fn) {
      const widgetClass = (0, _widget.queryRegistry)(widget) || this.container.factoryFor(`widget:${widget}`).class;
    ...
    includePostAttributes() {
      (0, _transformPost.includeAttributes)(...arguments);
    }
    ...
    addPostMenuButton(name, callback) {
      _postMenu.apiExtraButtons[name] = callback;
    ...
    removePostMenuButton(name, callback) {
      (0, _postMenu.removeButton)(name, callback);
    }
    ...
    addToolbarPopupMenuOptionsCallback(callback) {
      (0, _composer2.addPopupMenuOptionsCallback)(callback);
    }
    ...
    registerTopicFooterButton(buttonOptions) {
      (0, _registerTopicFooterButton.registerTopicFooterButton)(buttonOptions);
    }
    ...
    registerTopicFooterDropdown(dropdownOptions) {
      (0, _registerTopicFooterDropdown.registerTopicFooterDropdown)(dropdownOptions);
    }
    ...
    registerDesktopNotificationHandler(handler) {
      (0, _desktopNotifications.registerDesktopNotificationHandler)(handler);
    }
    ...
    addGroupPostSmallActionCode(actionCode) {
      (0, _postSmallAction.addGroupPostSmallActionCode)(actionCode);
    }
    ...
    addPostSmallActionClassesCallback(callback) {
      (0, _postSmallAction.addPostSmallActionClassesCallback)(callback);
    }
    ...
    addTopicParticipantClassesCallback(callback) {
      (0, _topicMap.addTopicParticipantClassesCallback)(callback);
    }
    ...
    addTopicSummaryCallback(callback) {
      (0, _toggleTopicSummary.addTopicSummaryCallback)(callback);
    }
    ...
    addNavigationBarItem(item) {
      if (!item["name"]) {
        // eslint-disable-next-line no-console
        console.warn((0, _sourceIdentifier.consolePrefix)(), "A 'name' is required when adding a Navigation Bar Item.", item);
      } else {
    ...
    addComposerUploadPreProcessor(pluginClass, optionsResolverFn) {
      (0, _composerEditor.addComposerUploadPreProcessor)(pluginClass, optionsResolverFn);
    }
    ...
    addUsernameSelectorDecorator(decorator) {
      (0, _decorateUsernameSelector.addUsernameSelectorDecorator)(decorator);
    }
    ...
    addComposerSaveErrorCallback(callback) {
      (0, _composer2.addComposerSaveErrorCallback)(callback);
    }
    ...
    serializeToTopic(fieldName, property) {
      _composer.default.serializeToTopic(fieldName, property);
    }
    ...
    serializeToDraft(fieldName, property) {
      _composer.default.serializeToDraft(fieldName, property);
    }
    ...
    serializeOnCreate(fieldName, property) {
      _composer.default.serializeOnCreate(fieldName, property);
    }
    ...
    serializeOnUpdate(fieldName, property) {
      _composer.default.serializeOnUpdate(fieldName, property);
    }
    ...
    addCardClickListenerSelector(selector) {
      (0, _cardContentsBase.addCardClickListenerSelector)(selector);
    }
    ...
    registerCustomLastUnreadUrlCallback(fn) {
      (0, _topic2.registerCustomLastUnreadUrlCallback)(fn);
    }
    ...
    registerHighlightJSPlugin(plugin) {
      (0, _highlightSyntax.registerHighlightJSPlugin)(plugin);
    }
    ...
    addGlobalNotice(text, id, options) {
      (0, _globalNotice.addGlobalNotice)(text, id, options);
    }
    ...
    addDocumentTitleCounter(counterFunction) {
      (0, _dDocument.addPluginDocumentTitleCounter)(counterFunction);
    }
    /**
    ...
    decorateTopicTitle(callback) {
      (0, _topicTitle.addTopicTitleDecorator)(callback);
    }
    ...
    addCategoryLinkIcon(renderer) {
      (0, _categoryLink.addExtraIconRenderer)(renderer);
    }
    /**
    ...
    addToHeaderIcons(icon) {
      (0, _header.addToHeaderIcons)(icon);
    }
    ...
    addQuickAccessProfileItem(item) {
      (0, _quickAccessProfile.addQuickAccessProfileItem)(item);
      (0, _profileTabContent.addUserMenuProfileTabItem)(item);
    }
    addFeaturedLinkMetaDecorator(decorator) {
      (0, _renderTopicFeaturedLink.addFeaturedLinkMetaDecorator)(decorator);
    }
    ...
    addAdvancedSearchOptions(options) {
      (0, _searchAdvancedOptions.addAdvancedSearchOptions)(options);
    }
    addSaveableUserField(fieldName) {
      (0, _user.addSaveableUserField)(fieldName);
    }
    addSaveableUserOptionField(fieldName) {
      (0, _user.addSaveableUserOptionField)(fieldName);
    }
    addPluginReviewableParam(reviewableType, param) {
      (0, _reviewableItem.addPluginReviewableParam)(reviewableType, param);
    }
    ...
    setNewCategoryDefaultColors(backgroundColor, textColor) {
      (0, _newCategory.setNewCategoryDefaultColors)(backgroundColor, textColor);
    }
    ...
    addSearchResultsCallback(callback) {
      (0, _search.addSearchResultsCallback)(callback);
    }
    ...
    addSearchSuggestion(value) {
      (0, _searchMenuResults.addSearchSuggestion)(value);
    }
    ...
    downloadCalendar(title, dates) {
      (0, _downloadCalendar.downloadCalendar)(title, dates);
    }
    ...
    addQuickSearchRandomTip(tip) {
      (0, _searchMenuResults.addQuickSearchRandomTip)(tip);
    }
    ...
    addUserSearchOption(value) {
      _userChooser.CUSTOM_USER_SEARCH_OPTIONS.push(value);
    }
    ...
    customizeComposerText(callbacks) {
      (0, _composer.registerCustomizationCallback)(callbacks);
    }
    ...
    addCommunitySectionLink(arg, secondary) {
      (0, _customCommunitySectionLinks.addSectionLink)(arg, secondary);
    }
     ...
     */
    registerUserCategorySectionLinkCountable(_ref) {
      let {
        badgeTextFunction,
        route,
        routeQuery,
      ...
      (0, _categorySectionLink.registerCustomCountable)({
        badgeTextFunction,
        route,
        routeQuery,
        shouldRegister,
    ...
    refreshUserSidebarCategoriesSectionCounts() {
      const appEvents = this._lookupContainer("service:app-events");
      appEvents?.trigger(_categoriesSection.REFRESH_COUNTS_APP_EVENT_NAME);
    }
    ...
    addSidebarSection(func) {
      (0, _customSections.addSidebarSection)(func);
    }
    ...
    registerNotificationTypeRenderer(notificationType, func) {
      (0, _notificationTypesManager.registerNotificationTypeRenderer)(notificationType, func);
    }
    ...
    registerUserMenuTab(func) {
      (0, _tab.registerUserMenuTab)(func);
    }
    ...
    registerModelTransformer(modelName, transformer) {
      (0, _modelTransformers.registerModelTransformer)(modelName, transformer);
    }
    ...
    addUserMessagesNavigationDropdownRow(routeName, name, icon) {
      (0, _userPrivateMessages.registerCustomUserNavMessagesDropdownRow)(routeName, name, icon);
    }
    ...
    addFullPageSearchType(translationKey, searchTypeId, searchFunc) {
      (0, _fullPageSearch.registerFullPageSearchType)(translationKey, searchTypeId, searchFunc);
    }
    ...
    registerHashtagType(type, typeClass) {
      (0, _hashtagAutocomplete.registerHashtagType)(type, typeClass);
    }
  }
  ...
  function getPluginApi(version) {
    ...
    if (cmpVersions(version, PLUGIN_API_VERSION) <= 0) {
      ...
      // eslint-disable-next-line no-console
      console.warn((0, _sourceIdentifier.consolePrefix)(), `Plugin API v${version} is not supported`);
    }
  }
  ...
  function decorate(klass, evt, cb, id) {
    if (!id) {
      // eslint-disable-next-line no-console
      console.warn((0, _sourceIdentifier.consolePrefix)(), "`decorateCooked` should be supplied with an `id` option to avoid memory leaks in test mode. The id will be used to ensure the decorator is only applied once.");
    } else {
    ...
    mixin[name] = (0, _evented.on)(evt, function (elem) {
