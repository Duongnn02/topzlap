define("discourse/lib/media-optimization-utils", ["exports", "rsvp", "discourse-common/lib/helpers"], function (_exports, _rsvp, _helpers) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.fileToImageData = fileToImageData;
  0; //eaimeta@70e063a35619d71f0,"rsvp",0,"discourse-common/lib/helpers"eaimeta@70e063a35619d71f
  ...
  async function fileToDrawable(file) {
    ...
    if ("createImageBitmap" in self && !caps.isApple) {
      ...
      img.decoding = "async";
      img.src = url;
      const loaded = new _rsvp.Promise((resolve, reject) => {
        img.onload = () => resolve();
