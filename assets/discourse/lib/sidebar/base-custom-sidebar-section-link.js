define("discourse/lib/sidebar/base-custom-sidebar-section-link", ["exports"], function (_exports) {
  "use strict";
   ...
   */
  class BaseCustomSidebarSectionLink {
    /**
  ...
  _exports.default = BaseCustomSidebarSectionLink;
});