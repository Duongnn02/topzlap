define("discourse/lib/sidebar/base-community-section-link", ["exports"], function (_exports) {
  "use strict";
   ...
   */
  class BaseCommunitySectionLink {
    constructor() {
      let {
        topicTrackingState,
        currentUser,
  ...
  _exports.default = BaseCommunitySectionLink;
});