define("discourse/lib/notification-types/membership-request-consolidated", ["exports", "discourse/lib/notification-types/base", "discourse/lib/url", "I18n"], function (_exports, _base, _url, _I18n) {
  "use strict";
  ...
  class _default extends _base.default {
    get linkHref() {
      return (0, _url.userPath)(`${this.notification.username || this.currentUser.username}/messages`);
    }
    get description() {
