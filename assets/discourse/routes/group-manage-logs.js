define("discourse/routes/group-manage-logs", ["exports", "discourse/routes/discourse", "I18n", "@ember/object"], function (_exports, _discourse, _I18n, _object) {
  "use strict";
  ...
  var _default = _discourse.default.extend((_obj = {
    titleToken() {
      return _I18n.default.t("groups.manage.logs.title");
    },
    model() {
