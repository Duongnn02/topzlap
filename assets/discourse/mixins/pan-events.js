define("discourse/mixins/pan-events", ["exports", "@ember/object/mixin"], function (_exports, _mixin) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.default = _exports.SWIPE_VELOCITY_THRESHOLD = _exports.SWIPE_DISTANCE_THRESHOLD = _exports.MINIMUM_SWIPE_DISTANCE = void 0;
  ...
  const MINIMUM_SWIPE_DISTANCE = 5;
  ...
  var _default = _mixin.default.create({
    ...
    addTouchListeners(element) {
      if (this.site.mobileView) {
        ...
        this.touchEnd = e => this._panMove({
          type: "pointerup"
        }, e);
        this.touchCancel = e => this._panMove({
          type: "pointercancel"
        }, e);
        const opts = {
          passive: false
