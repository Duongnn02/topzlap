define("discourse/widgets/hooks", ["exports"], function (_exports) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.WidgetTouchStartHook = _exports.WidgetTouchEndHook = _exports.WidgetMouseUpHook = _exports.WidgetMouseOverHook = _exports.WidgetMouseOutHook = _exports.WidgetMouseMoveHook = _exports.WidgetMouseDownOutsideHook = _exports.WidgetMouseDownHook = _exports.WidgetKeyUpHook = _exports.WidgetKeyDownHook = _exports.WidgetInputHook = _exports.WidgetDragHook = _exports.WidgetDoubleClickHook = _exports.WidgetClickOutsideHook = _exports.WidgetClickHook = _exports.WidgetChangeHook = void 0;
  ...
  const MOUSE_DOWN_OUTSIDE_ATTRIBUTE_NAME = "_discourse_mouse_down_outside_widget";
  ...
  const WidgetClickHook = buildHook(CLICK_ATTRIBUTE_NAME);
  _exports.WidgetClickHook = WidgetClickHook;
  const WidgetDoubleClickHook = buildHook(DOUBLE_CLICK_ATTRIBUTE_NAME);
  _exports.WidgetDoubleClickHook = WidgetDoubleClickHook;
  const WidgetClickOutsideHook = buildHook(CLICK_OUTSIDE_ATTRIBUTE_NAME, "data-click-outside");
  _exports.WidgetClickOutsideHook = WidgetClickOutsideHook;
  const WidgetMouseDownOutsideHook = buildHook(MOUSE_DOWN_OUTSIDE_ATTRIBUTE_NAME, "data-mouse-down-outside");
  _exports.WidgetMouseDownOutsideHook = WidgetMouseDownOutsideHook;
  const WidgetKeyUpHook = buildHook(KEY_UP_ATTRIBUTE_NAME);
  _exports.WidgetKeyUpHook = WidgetKeyUpHook;
  const WidgetKeyDownHook = buildHook(KEY_DOWN_ATTRIBUTE_NAME);
  _exports.WidgetKeyDownHook = WidgetKeyDownHook;
  const WidgetInputHook = buildHook(INPUT_ATTRIBUTE_NAME);
  _exports.WidgetInputHook = WidgetInputHook;
  const WidgetChangeHook = buildHook(CHANGE_ATTRIBUTE_NAME);
  _exports.WidgetChangeHook = WidgetChangeHook;
  const WidgetMouseUpHook = buildHook(MOUSE_UP_ATTRIBUTE_NAME);
  _exports.WidgetMouseUpHook = WidgetMouseUpHook;
  const WidgetMouseDownHook = buildHook(MOUSE_DOWN_ATTRIBUTE_NAME);
  _exports.WidgetMouseDownHook = WidgetMouseDownHook;
  const WidgetMouseMoveHook = buildHook(MOUSE_MOVE_ATTRIBUTE_NAME);
  _exports.WidgetMouseMoveHook = WidgetMouseMoveHook;
  const WidgetMouseOverHook = buildHook(MOUSE_OVER_ATTRIBUTE_NAME);
  _exports.WidgetMouseOverHook = WidgetMouseOverHook;
  const WidgetMouseOutHook = buildHook(MOUSE_OUT_ATTRIBUTE_NAME);
  _exports.WidgetMouseOutHook = WidgetMouseOutHook;
  const WidgetTouchEndHook = buildHook(TOUCH_END_ATTRIBUTE_NAME);
  ...
  _exports.WidgetTouchEndHook = WidgetTouchEndHook;
  function touchStartHandler(e) {
    return e.currentTarget[TOUCH_START_ATTRIBUTE_NAME].touchStart(e);
  }
  class WidgetTouchStartHook extends WidgetBaseHook {
  ...
  _exports.WidgetTouchStartHook = WidgetTouchStartHook;
  ...
  class WidgetDragHook extends WidgetBaseHook {
    hook(node, propertyName, previousValue) {
  ...
  _exports.WidgetDragHook = WidgetDragHook;
