define("discourse/widgets/post-admin-menu", ["exports", "discourse/widgets/button", "discourse/widgets/widget", "virtual-dom"], function (_exports, _button, _widget, _virtualDom) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"discourse/widgets/button",0,"discourse/widgets/widget",0,"virtual-dom"eaimeta@70e063a35619d71f
  (0, _widget.createWidget)("post-admin-menu-button", Object.assign(_button.ButtonClass, {
    tagName: "li.btn"
  }));
  (0, _widget.createWidget)("post-admin-menu-button", {
    tagName: "li",
    html(attrs) {
  ...
  function buildManageButtons(attrs, currentUser, siteSettings) {
    ...
    if (attrs.canEditStaffNotes) {
      contents.push({
        icon: "user-shield",
        label: attrs.notice ? "post.controls.change_post_notice" : "post.controls.add_post_notice",
        action: "changeNotice",
        className: attrs.notice ? "popup-menu-button change-notice" : "popup-menu-button add-notice"
      });
    }
    ...
    if (currentUser.admin || siteSettings.moderators_change_post_ownership && currentUser.staff) {
      contents.push({
        icon: "user",
  ...
  var _default = (0, _widget.createWidget)("post-admin-menu", {
