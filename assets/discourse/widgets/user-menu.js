define("discourse/widgets/user-menu", ["exports", "discourse-common/lib/later", "discourse/widgets/widget", "virtual-dom", "discourse/lib/show-modal", "I18n"], function (_exports, _later, _widget, _virtualDom, _showModal, _I18n) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"discourse-common/lib/later",0,"discourse/widgets/widget",0,"virtual-dom",0,"discourse/lib/show-modal",0,"I18n"eaimeta@70e063a35619d71f
  ...
  (0, _widget.createWidget)("user-menu-links", {
    ...
    notificationsGlyph() {
      return {
        ...
        data: {
          url: `${this.attrs.path}/notifications`
        },
        role: "tab",
    ...
    bookmarksGlyph() {
      return {
        ...
        icon: "bookmark",
        data: {
          url: `${this.attrs.path}/activity/bookmarks`
        },
  ...
  var _default = (0, _widget.createWidget)("user-menu", {
    ...
    userMenuNavigation(nav) {
      ...
      document.querySelector(`.menu-link[role='tab'][data-tab-number='${nextTab}']`).focus();
    },
    defaultState() {
      return {
    ...
    panelContents() {
      ...
      const result = [this.attach("user-menu-links", {
        path,
        currentQuickAccess
    ...
    clickOutsideMobile(e) {
      ...
      if (!centeredElement.classList.contains("header-cloak") && parents) {
        ...
        let offsetDirection = document.querySelector("html").classList["direction"] === "rtl" ? -1 : 1;
        panel.style.setProperty("--offset", `${offsetDirection * windowWidth}px`);
        const headerCloak = document.querySelector(".header-cloak");
        headerCloak.classList.add("animate");
        headerCloak.style.setProperty("--opacity", 0);
        (0, _later.default)(() => this.sendWidgetAction("toggleUserMenu"), 200);
      }
    },
    clickOutside(e) {
