define("discourse/components/user-menu/messages-list-empty-state", ["exports", "@ember/component", "@ember/template-factory", "@ember/component/template-only"], function (_exports, _component, _templateFactory, _templateOnly) {
  "use strict";
      ...
      <p>
        {{html-safe
          (i18n
            ...
            icon=(d-icon "envelope")
            aboutUrl=(get-url "/about")
          )
        }}
      </p>
    </div>
  ...
  */
  {
    ...
    "moduleName": "discourse/components/user-menu/messages-list-empty-state.hbs",
    "isStrictMode": false
  });
