define("discourse/components/flat-button", ["exports", "@ember/component", "@ember/template-factory", "I18n", "discourse-common/utils/decorators"], function (_exports, _component, _templateFactory, _I18n, _decorators) {
  "use strict";
  ...
  */
  ...
  var _default = (0, _component.setComponentTemplate)(__COLOCATED_TEMPLATE__, _component.default.extend((_dec = (0, _decorators.default)("title"), (_obj = {
    tagName: "button",
    classNames: ["btn-flat"],
