define("discourse/controllers/ignore-duration-with-username", ["exports", "@ember/controller", "I18n", "discourse/mixins/modal-functionality", "discourse/models/user", "discourse/lib/ajax-error", "discourse/lib/time-shortcut", "discourse-common/utils/decorators"], function (_exports, _controller, _I18n, _modalFunctionality, _user, _ajaxError, _timeShortcut, _decorators) {
  "use strict";
  ...
  var _obj;
  0; //eaimeta@70e063a35619d71f0,"@ember/controller",0,"I18n",0,"discourse/mixins/modal-functionality",0,"discourse/models/user",0,"discourse/lib/ajax-error",0,"discourse/lib/time-shortcut",0,"discourse-common/utils/decorators"eaimeta@70e063a35619d71f
  ...
  var _default = _controller.default.extend(_modalFunctionality.default, (_obj = {
    ...
    actions: {
      ignore() {
        ...
        _user.default.findByUsername(this.ignoredUsername).then(user => {
